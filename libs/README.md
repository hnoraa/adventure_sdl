...
1. Select C/C++>General
	1.1 In Additional Include Directories add <SDL install location>\include
2. Select Linker>General
	2.1 In Additional Library Directories add <SDL install location>\lib\<x86|x64>
3. Select Linker>Input
	3.1 In Additional Dependencies add SDL2.lin and SDL2main.lib
4. Select Linker>System
	4.1 Set SubSystem to Console (/SUBSYSTEM:CONSOLE)
